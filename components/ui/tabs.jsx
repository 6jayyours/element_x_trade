...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center xl:bg-white rounded-md dark:md:bg:secondary bg-muted p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
